          ...
          <div className="p-4 md:p-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6">
              ...
              <div className="relative flex-shrink-0">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-brand rounded-full flex items-center justify-center">
                  ...
                  {editingPhone ? (
                    <form onSubmit={handleSavePhone} className="flex items-center gap-2">
                      <input
                        ...
                        className={`border rounded px-2 py-1 text-sm w-36 focus:ring-2 focus:ring-brand focus:border-brand ${
                    ...
                    <>
                      ...
                      <button
                        className="ml-2 text-brand hover:text-brand p-1 rounded transition-colors"
          ...
          <div className="px-4 md:px-6 py-3 md:py-4 border-b border-slate-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="bg-brand hover:bg-brand text-white text-sm font-semibold py-2 px-3 rounded-lg flex items-center space-x-1.5"
              >
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
                      ...
                      <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-3.5 md:py-4 border-b border-slate-200 sticky top-0 bg-white">
                        <div className="flex items-center justify-between">
                          <h3 className="text-sm sm:text-base md:text-lg font-bold text-slate-900 flex items-center">
                            {editingAddress ? (
                              <>
                                <Edit className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 mr-1.5 sm:mr-2 text-brand" />
                                <span className="hidden xs:inline">Editar Endereço</span>
                                <span className="xs:hidden">Editar</span>
                              </>
                            ) : (
                              <>
                                <Plus className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 mr-1.5 sm:mr-2 text-brand" />
                    ...
                    <form onSubmit={editingAddress ? handleUpdateAddress : handleAddAddress} className="p-3 sm:p-4 md:p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-3.5 md:gap-4 mb-4 sm:mb-5 md:mb-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-3 py-2 sm:px-3.5 sm:py-2.5 md:px-4 md:py-3 text-sm sm:text-base border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-brand focus:border-brand transition-all duration-200 ${!hasNumber ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                            placeholder="123"
                            required={hasNumber}
                            disabled={!hasNumber}
                          />
                        ...
                        <div className="md:col-span-2">
                          <label className="flex items-center space-x-2 sm:space-x-2.5 cursor-pointer">
                            <input
                              ...
                              className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5 text-brand focus:ring-brand border-2 border-gray-300 rounded transition-all duration-200"
                            />
                      ...
                      <div className="flex justify-end space-x-2 sm:space-x-2.5 md:space-x-3">
                        ...
                        <button
                          type="submit"
                          className="px-3 py-2 sm:px-4 sm:py-2.5 md:px-6 md:py-3 text-sm sm:text-base bg-brand text-white rounded-lg hover:bg-brand font-semibold transition-all duration-200 shadow-lg flex items-center space-x-1.5 sm:space-x-2"
                        >
                          {editingAddress ? (
                            <>
                    ...
                    {addresses.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <button
                          ...
                          className="bg-brand hover:bg-brand text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 shadow-md flex items-center space-x-2 mx-auto"
                        >
                      ...
                      addresses.map((address) => (
                        <div key={address.id} className="group relative bg-white rounded-xl border border-slate-200 hover:border-brand p-3 sm:p-4 md:p-5 transition-all duration-200 hover:shadow-md">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="mb-2 sm:mb-3">
                                <div className="flex items-start gap-2 sm:gap-3">
                                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-brand/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <MapPin className="w-4 h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5 text-brand" />
                                  </div>
                                  <div className="flex-1 min-w-0">
                            ...
                            <div className="flex-shrink-0 flex flex-col items-end gap-1.5 sm:gap-2">
                              ...
                              <div className="flex items-center gap-1.5 sm:gap-2">
                                <button 
                                  ...
                                  className="p-1.5 sm:p-2 bg-brand/10 text-brand hover:bg-brand hover:text-white rounded-md transition-all duration-200"
